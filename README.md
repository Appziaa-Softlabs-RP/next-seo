...
For standard meta data (e.g., &lt;meta&gt;, &lt;title&gt;) then it is highly recommended that you use the built-in `generateMetaData` method. You can check out the docs [here](https://nextjs.org/docs/app/building-your-application/optimizing/metadata)
...
- [Next SEO](#next-seo)
  ...
  - [Reference \& Improvements](#reference--improvements)
...
If you are using the Next.js app directory, then it is highly recommended that you use the built-in `generateMetaData` method. You can check out the docs [here](https://nextjs.org/docs/app/building-your-application/optimizing/metadata)
...
Some tools may report this as an error. See [Issue #14](https://github.com/rewardsplus/next-seo/issues/14)
...
This project is inspired by [next-seo](https://github.com/garmeeh/next-seo) but extends it with new features and improvements for modern Next.js applications. 🚀